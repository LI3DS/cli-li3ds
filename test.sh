...
mm2li import-orimatis $MM2LIARGS $@ --sensor Sensor0 -b $(pwd)/data/image -f $(pwd)/data spheric.ori.xml
mm2li import-orimatis $MM2LIARGS $@ -b $(pwd)/data/image -f $(pwd)/data 'conic*.ori.xml'
